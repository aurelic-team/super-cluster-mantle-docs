...
const sidebars: SidebarsConfig = {
  tutorialSidebar: [
    ...
    },
    {
      ...
      link: {
        type: 'doc',
        id: 'protocol_mechanic/architecture',
      },
      items: [
        'protocol_mechanic/architecture',
        'protocol_mechanic/strategy_layer',
        'protocol_mechanic/modular_yield_adapters',
        'protocol_mechanic/risk_and_safety_model',
      ],
    },
    {
      type: 'category',
    ...
    },
    {
      ...
      items: [
        'conclusion/design_philosophy',
        'conclusion/whats_next',
      ],
    },
    'support',
  ],
